...
$array["brand_id"] = isset($_POST["brands"]) ? $_POST["brands"] : (! empty($p["brand_id"]) ? $p["brand_id"] : "");
$array["unity_id"] = isset($_POST["unities"]) ? $_POST["unities"] : (! empty($p["unity_id"]) ? $p["unity_id"] : "");
$array["category_id"] = isset($_POST["categories"]) ? $_POST["categories"] : (! empty($p["category_id"]) ? $p["category_id"] : "");
...
$array["price_sell"] = ! empty($_POST["price-sell"]) ? $_POST["price-sell"] : (! empty($p["price_sell"]) ? $p["price_sell"] : "");
